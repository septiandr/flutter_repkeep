...
class ExcerciseProvider with ChangeNotifier {
  ...
  Future<void> loadExercises() async {
    _isLoading = true;
    debugPrint("loaing ${_isLoading}");
    notifyListeners();

    _exercises = await DatabaseHelper.instance.getAllExercises();
    debugPrint("LoadExercises: data fetched ${_exercises.length}");
  ...
  Future<void> addExercise(Exercise exercise) async {
    // Insert into DB. The returned 'id' is generated by SQLite
    final id = await DatabaseHelper.instance.insertExercise(exercise);

    // Update the exercise object with the new id
    final exerciseWithId = exercise.copyWith(id: id);

    // Add to your in-memory list
